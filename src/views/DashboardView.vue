<template>
  ...
  >
    <ProfileComponent />
    <section
      class="m-4 flex gap-4 flex-col justify-between items-center p-4 rounded w-full"
    >
      ...
      <section
        class="flex flex-col lg:flex-row gap-4 lg:gap-[1rem] justify-center w-full"
      >
        <div class="flex flex-col gap-4">
          <div class="relative">
            <h1
              class="text-[1.5rem] bg-[#1a1a1a] top-1 p-2 rounded roboto-bold relative border-l-2 border-[#3498db]"
            >
              Top Shows
            </h1>
